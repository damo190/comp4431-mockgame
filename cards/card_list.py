...
card_catalog = {
    ...
    "hearty_breakfast": Card(CardType.HEAL, 3, CardTarget.SELF, "hearty_breakfast", "A tasty meal"),
    "feast_for_one": Card(CardType.HEAL, 5, CardTarget.SELF, "feast_for_one", "A real tasty time!"),
